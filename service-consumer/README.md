...
4. 🔐 [How the consumer does mutual TLS](#how-the-consumer-does-mutual-tls)
5. 🌐 [API](#api)
...
Generated by [`../certs/generate-certs.sh`](../certs/generate-certs.sh).
...
└── src
    ...
    │       ├── application.yml
    │       ├── banner.txt
    │       └── ssl/service-consumer-keystore.p12, truststore.p12
